...
Alors, 
$$\left|\left| \overrightarrow{L_{O}} \right|\right|  = \left|\left| O \overrightarrow{M_{0}} \wedge m\vec{v}_{0} \right|\right|  = \left|\left| O \overrightarrow{M_{1}} \wedge m\vec{v}_{1} \right|\right|  = bv_{0} =dv_{1}$$
