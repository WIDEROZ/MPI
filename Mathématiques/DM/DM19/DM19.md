...
De plus : 
$$\forall n \in \mathbb{N}, \mathbb{P}(S_{2n + 1}=0) = \mathbb{P}\left( T_{2n+1} =n+\frac{1}{2} \right) = \mathbb{P}(\varnothing) = 0 \text{ car } T_{2n+1} \sim B(n, p) \subset \mathbb{N}$$
Alors comme : 
...
#### d.
$$\mathbb{P}(S_{n} \leq 0) = 1- \mathbb{P}(S_{n} > 0) = 1- \sum_{k = 1}^{n}\mathbb{P}(S_{n} = k) = 1- \sum_{k = 1}^{\left\lfloor \frac{n}{2} \right\rfloor } \binom{2k}{k}4^{-k} $$
