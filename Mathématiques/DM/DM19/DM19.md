...
#### e.
$$ \int_{- \infty}^{+ \infty} e^{ -\frac{x^{2}}{2} } \frac{1- e^{ -ixb }}{ix} \, dt = \int_{0}^{+ \infty} e^{ -\frac{x^{2}}{2} } \frac{1-e^{ -ixb }}{ix}\, dx $$
$$= \int_{0}^{+ \infty} e^{ -\frac{x^{2}}{2} } \left( \frac{e^{ ixb }- e^{ -ixb }}{2ix} + \frac{1-e^{ ixb }}{2ix} \right) \, dx $$
$$= \int_{0}^{+ \infty} e^{ -\frac{x^{2}}{2} } \frac{\sin(xb)}{x} \, dx $$