...
$$\cos\left( \frac{x}{\sqrt{n}} \right)^{n} \sim \frac{(e^{ ix/\sqrt{n} } + e^{ -ix/\sqrt{n} })^{n}}{2^{n}} = \frac{1}{2^{n}} \sum_{k = 0}^{n} \binom{n}{k} e^{ ix \frac{k}{\sqrt{n}} }e^{ ix \frac{n-k}{\sqrt{n}} }$$
$$= \frac{1}{2^{n}} \sum_{k = 0}^{n} \binom{n}{k} e^{ ix\sqrt{n} } = e^{ ix\sqrt{n} } \sum_{k = 0}^{n} \frac{n! 2^{-n}}{(n-k)!k!}$$