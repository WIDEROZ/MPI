...
$$\forall x \in \left[ 0, \frac{\pi}{2} \right], \sin(x) - \frac{2}{\pi}x\geq 0 \text{ car : } \sin(x) \geq 0 \text{ et }  $$
$$\forall x \in \left[ 0, \frac{\pi}{2} \right], \cos(x) -\frac{2}{\pi} \text{ est monotone décroissante}$$
et puis : 