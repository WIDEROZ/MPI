...
$$\cos\left( \frac{x}{\sqrt{n}} \right)^{n} = \left( 1-\frac{x^{2}}{2n} + o(x^{2}) \right)^{n} \underset{n \to +\infty}{\longrightarrow} e^{ -\frac{x^{2}}{2}}$$car : 
$$\sum_{k= 0}^{n} \left( 1-\frac{x^{2}}{2n} \right)^{n-k} (o(x^{2}))^{k} = \left( 1-\frac{x^{2}}{2n} \right)^{n} \sum_{k= 0}^{n} \left( \frac{o(x^{2})}{1-\frac{x^{2}}{2n}} \right)^{k} $$
$$= e^{ -\frac{x^{2}}{2n} } \sum_{k= 0}^{n}$$