...
#### b.
$$\mathbb{E}(e^{ itS_{n} }) = \sum_{j = -n}^{n} \mathbb{P}(S_{n}=j) e^{ itj } =\frac{1}{2\pi}\int_{-\pi}^{\pi} \sum_{j = -n}^{n} \mathbb{E}(e^{ ixS_{n} }) e^{ -i(x-t)j } \, dx $$
$$= \frac{1}{2\pi} \int_{-\pi}^{\pi}\mathbb{E}(e^{ ixS_{n} }) A \, dx $$
$$A = \left( \frac{1-e^{ -i(x-t)(n+1) }}{1-e^{ -i(x-t) }} \right) + \sum_{j = 1}^{n} e^{ i(x-t)j }  $$
$$=  \left( \frac{1-e^{ -i(x-t)(n+1) }}{1-e^{ -i(x-t) }} \right) + $$
