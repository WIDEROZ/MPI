...
$$\left|\left| \sum_{n = 1}^{+ \infty}\left( \frac{1}{x+n}+\frac{1}{x-n} \right) \right|\right| _{\infty, \mathbb{R} \setminus \mathbb{Z}} \leq \sum_{n = 1}^{+ \infty} \left( \left|\left| \frac{1}{x+n} \right|\right| + \left|\left| \frac{1}{x-n} \right|\right|  \right)$$
$$\leq $$