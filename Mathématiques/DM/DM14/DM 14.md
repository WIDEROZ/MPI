...
car : 
$$\frac{h-e^{ h }-1}{h(e^{ h }-1)} \underset{h \to 0}{=} \frac{h-h+\frac{h^{2}}{2}+o(h)}{h\left( h+ o(h) \right)} \underset{h \to 0}{=} \frac{h^{2}}{2h^{2} + o(h^{2})} +o(1)\underset{h\to 0}{\longrightarrow} \frac{1}{2}$$
Et donc : 
