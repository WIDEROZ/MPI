...
Or, 
$$\left| \frac{x}{x^{2}-n^{2}}\right| = O\left( \frac{1}{n^{2}} \right) \text{ et } \sum_{n = 1}^{+ \infty} \frac{1}{n^{2}} \text{ converge absolument}$$
car : 
$$\forall x \in \mathbb{R} \setminus \mathbb{Z}, \left( \frac{x}{n} \right)^{2}-1 \geq -1 $$
alors, 
$$\forall x \in \mathbb{R} \setminus \mathbb{Z}, \frac{1}{\left( \frac{x}{n} \right)^{2}-1} \leq - 1$$



$$\left| \frac{x}{\left( \frac{x}{n} \right)^{2}-1}\right| \leq \left| x\right|$$
...
$x\mapsto  \underset{n=1}{\overset{+ \infty}{\sum}}\left( \frac{1}{x+n} + \frac{1}{x-n} \right)$ l'est aussi par somme de fonctions et convergence uniforme de la somme. 
Donc, 
