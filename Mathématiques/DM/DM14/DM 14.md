...
et
$$h''(0) = \lim_{ h \to 0 } \frac{h'(h) +\frac{1}{2}}{h} = \lim_{ h \to 0 } \frac{e^{ h }-1-he^{ h }}{(e^{ h }-1)^{2}h} = \lim_{ h \to 0 } \frac{h+\frac{h^{2}}{2} - h-h^{2}-\frac{h^{3}}{2}+ o(h^{3})}{(h+\frac{h^{2}}{2}+o(h^{2}))^{2}h} = \lim_{ _h  \to 0 }  $$
