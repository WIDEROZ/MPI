...
car en posant : 
$$\forall k, n \in \mathbb{N}^{*}, h_{k, n}(y) = \left( \left( \frac{y}{2\pi_{n}} \right)^{2} \right)^{k}$$
$$\sum_{n \in \mathbb{N}^{*}}\left( \sum_{n = 1}^{+ \infty}  \left( \left( \frac{y}{2\pi n} \right)^{2} \right)^{k}\right) \text{ CVU}$$
car : 


or : 
$$n \geq 37 \Rightarrow  r = \left( \frac{y}{2\pi n} \right)^{2}< 1$$
Alors, 
$$\sum_{k=1}^{+ \infty} r^{k} = \frac{r}{1-r}$$
Donc, 
$$2\sum_{n =1}^{+ \infty} \sum_{k = 1}^{+ \infty} \left( \left( \frac{y}{2\pi n} \right)^{2} \right)^{k} = 2  \sum_{n = 1}^{+ \infty} \frac{\left( \frac{y}{2\pi n} \right)^{2}}{1-\left( \frac{y}{2\pi n} \right)^{2}} = 2\sum_{n = 1}^{+ \infty} \frac{\left( \frac{y}{2\pi} \right)^{2}}{n^{2}-\left( \frac{y}{2\pi} \right)^{2}}$$
...
Ainsi, 
$$\frac{x}{2} \mathrm{cotan}\left( \frac{y}{2} \right) = 1-\sum_{k = 1}^{+ \infty} \frac{\zeta(2k)}{2^{2k-1}\pi^{2k}}y^{2k}$$
