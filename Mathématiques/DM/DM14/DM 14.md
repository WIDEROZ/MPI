...
Et puis,
$$\int _{a}^{b} \pi \mathrm{cotan}(\pi x) \, dx = \int_{a}^{b} \frac{\pi\cos(\pi x)}{\sin(\pi x)} \, dx = \ln\left( \frac{\sin(\pi b)}{\sin(\pi a)} \right) = \ln\left( \frac{b}{a} \right) - \sum_{n = 1}^{+ \infty}\ln\left( \frac{n^{2}-a^{2}}{n^{2}-b^{2}} \right)$$
On fait maintenant tendre $b$ vers $1$ et $a$ vers $0$
alors,
$$\ln \left| \frac{\sin(\pi b)}{\sin(\pi a)}\right| = \ln \left| -\frac{\sin(\pi b)}{\sin(\pi a + \pi)}\right| $$
$$\forall t \in ]0, 1[, \begin{cases}
\sin(\pi a + t\pi) \underset{a \to 0}{\longrightarrow}  \sin(t\pi) \\
\sin(\pi tb) \underset{b \to 1}{\longrightarrow} \sin(\pi t)
\end{cases} \text{ alors } \left| -\frac{\sin(\pi bt)}{\sin(\pi a + t\pi)}\right| \underset{a \to 0}{\longrightarrow} \left| - \frac{\sin(\pi bt)}{\sin(\pi t)}\right| \underset{b \to 1}{\longrightarrow} \left| -1\right| = 1 \underset{t \to 1}{\longrightarrow} 1 $$
