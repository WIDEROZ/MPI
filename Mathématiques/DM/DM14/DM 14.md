...
#### a.
Soit $x \in \mathbb{R} \setminus \mathbb{Z}$, 
$$ f\left( \frac{1+x}{2} \right) = \pi\mathrm{cotan}\left( \pi  \frac{1+x}{2} \right) = \pi  \frac{\cos\left( \frac{\pi}{2}+ \frac{x}{2} \right)}{\sin\left( \frac{\pi}{2}+ \frac{x}{2} \right)} =f\left( \frac{x}{2} \right)$$
car $\cos\left( \frac{\pi}{2}+ \frac{x}{2} \right)=\sin\left( \frac{x}{2} \right)$ et $\sin\left( \frac{\pi}{2}+ \frac{x}{2} \right)=-\cos\left( \frac{x}{2} \right)$
