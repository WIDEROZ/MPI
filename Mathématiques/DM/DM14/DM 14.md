...
Pour $0$ : 
$$\lim_{ h \to 0 } \frac{\frac{h}{e^{ h }-1}-1}{h} = \lim_{ h \to 0 } \left( \frac{1}{e^{ h }-1}- \frac{1}{h} \right) = \lim_{ h \to 0 } \left( \frac{h-e^{ h }-1}{h(e^{ h }-1)} \right)= 1$$
car : 
$$\frac{h-e^{ h }-1}{h(e^{ h }-1)} = \frac{h-h+\frac{h^{2}}{2}+o(h^{2})}{h\left( h+\frac{h^{2}}{2} + o(h^{2}) \right)} = \frac{h^{2}}{2h^{2} + h^{3}} +o(1)$$