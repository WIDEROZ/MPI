...
On étend cette égalité pour les : $z \in \mathbb{R} \setminus \mathbb{Z}$ 
Car la preuve de l'existence de la limite des sommes partielles dans l'expression précédente repose sur l'existence d'un certain rang $n_{0} = \left\lfloor \frac{\left| z\right|}{2\pi} \right\rfloor$ pour lequel 
$$\forall n\geq n_{0}, $$
