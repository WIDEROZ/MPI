...
$$x = \frac{y}{2\pi}$$
Alors, on pose : 
$$S = \sum_{k = 1}^{+ \infty} \frac{\zeta(2k)}{2^{2k-1}}$$
$$\sum_{k =1}^{+ \infty}\sum_{n = 1}^{+ \infty} \frac{y^{2k}}{2^{2k-1}\pi^{2k}n^{2k}} = 2\sum_{n =1}^{+ \infty} \sum_{k = 1}^{+ \infty} \left( \left( \frac{y}{2\pi n} \right)^{2} \right)^{k}$$
or : 
$$n \geq 37 \Rightarrow  r = \left( \frac{y}{2\pi n} \right)^{2}< 1$$
Alors, 
$$\sum_{k=1}^{+ \infty} r^{k} = \frac{r}{1-r}$$
Donc, 
$$2\sum_{n =1}^{+ \infty} \sum_{k = 1}^{+ \infty} \left( \left( \frac{y}{2\pi n} \right)^{2} \right)^{k} = 2  \sum_{n = 1}^{+ \infty} \frac{\left( \frac{y}{2\pi n} \right)^{2}}{1-\left( \frac{y}{2\pi n} \right)^{2}} = -2\sum_{n = 1}^{+ \infty} \frac{\left( \frac{y}{2\pi} \right)^{2}}{\left( \frac{y}{2\pi} \right)^{2}-n^{2}}$$

Ainsi comme $\frac{y}{2\pi} \in ]-2\pi, 2\pi[$, d'après la question 4.b
$$$$