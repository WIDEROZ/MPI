...
$$g \text{ est continue sur } I = ]n_{0}, n_{0}+1[ $$
ce qui implique que $g \text{ est continue sur } \mathbb{R} \setminus \mathbb{Z}$ 
Il suffit alors de montrer que pour tout segment de $I$ de $\mathbb{R} \setminus \mathbb{Z}$ 
Soit $n \in \mathbb{N}^{*}$,
Soit $a, b \in \mathbb{R} \setminus \mathbb{Z}$ tels que $a<b$ et $\left\lfloor a \right\rfloor = \left\lfloor b \right\rfloor$,
$[a, b]$ est donc un segment de $\mathbb{R} \setminus \mathbb{Z}$ 
...
Donc, 
$$\sum_{n \in \mathbb{N}^{*}}h_{n} \text{ converge normalement sur tout segment de }\mathbb{R} \setminus \mathbb{Z}$$
Ainsi, 
$$\sum_{n \in \mathbb{N}^{*}} h_{n} \text{ converge unformément sur tout segment de }\mathbb{R} \setminus \mathbb{Z}$$
