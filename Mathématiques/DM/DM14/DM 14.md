...
$$\tilde{D}(\alpha)=0$$
De plus, 
$$\forall x \in [1, 2], \lim_{ n \to +\infty }  \left( \frac{\alpha+\left\lfloor x 2^{n} \right\rfloor }{2^{n}} \right)  = x$$
Alors, comme : 
$$\tilde{D}\left( \frac{\alpha+ \left\lfloor x{2}^{n} \right\rfloor}{2^{n}} \right)= \tilde{D}\left( \frac{\alpha}{2^{n}} + \frac{\left\lfloor x 2^{n} \right\rfloor}{2^{n}} \right)= \tilde{D}\left( \frac{\alpha}{2^{n}} \right) = 0$$
car $\frac{\left\lfloor x 2^{n} \right\rfloor}{2^{n}} \in \mathbb{Z}$ car $\left\lfloor x 2^{n} \right\rfloor\geq 2^{n}$
On a : 
