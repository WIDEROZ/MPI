...
De plus, 
Soit $N \in \mathbb{N}^{*}$,
$$\sum_{n = 1}^{N} \left( \frac{1}{x+1+2n} +  \frac{1}{x+2+2n} \right) =\sum_{\underset{k \text{ impair}}{k =3}}^{2N+1} \frac{1}{x+k} + \sum_{\underset{k \text{ pair}}{k =4}}^{2N+2} \frac{1}{x+k}$$
...
Alors, 
$$\sum_{n = 1}^{N} \left( \frac{1}{x+1+2n} +  \frac{1}{x+2+2n} \right) $$
$$= \frac{1}{x+2N+2}+\frac{1}{x+2N+1}-\frac{1}{x+1} - \frac{1}{x+2}+\sum_{n = 1}^{2N} \frac{1}{x+n}$$
et
$$\sum_{n = 1}^{N}\left( \frac{1}{x+1-2n} + \frac{1}{x+2-2n} \right) = \frac{1}{x}- \frac{1}{x-2N} +\sum_{n = 1}^{2N} \frac{1}{x-n} $$
Donc, en notant : 
$$S_{N} = \underset{n=1}{\overset{N}{\sum}}\left( \frac{1}{x+1-2n} + \frac{1}{x+2-2n} + \frac{1}{x+1+2n} + \frac{1}{x+2+2n} \right)$$
$$\begin{array}{rl}
S_{N} &= \frac{1}{x+2N+2}+\frac{1}{x+2N+1}-\frac{1}{x-2N} \\
&+\frac{1}{x}-\frac{1}{x+1} - \frac{1}{x+2}+\underset{n=1}{\overset{2N}{\sum}} \left( \frac{1}{x+n} + \frac{1}{x-n} \right)
\end{array}$$
en faisant tendre $N$ vers $+\infty$, 
$$g\left( \frac{x+1}{2} \right) + g\left( \frac{x}{2} \right) = 2\left( \frac{2}{x} - \frac{1}{x+2} + \sum_{n = 1}^{+ \infty}\left( \frac{1}{x+n}+\frac{1}{x-n} \right) \right)$$
$$= 2\left( g(x) +\frac{1}{x}-\frac{1}{x+2} \right)$$
