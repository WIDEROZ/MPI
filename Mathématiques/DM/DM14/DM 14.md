...
Alors, 
$$\boxed{\prod_{n=1}^{+ \infty} \frac{1- \left( \frac{a}{n} \right)^{2} }{1-\left( \frac{b}{n} \right)^{2}}  = \frac{b\sin(\pi a)}{a\sin(\pi b)}}$$
Ainsi, 
$$\prod_{n = 1}^{+\infty}\left( 1-\left( \frac{x}{n} \right)^{2} \right) = \frac{\sin(\pi a)}{\pi a}$$
