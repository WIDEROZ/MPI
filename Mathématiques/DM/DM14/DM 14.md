...
$$= \tilde{D}\left( \frac{x}{2^{2}} \right) + \tilde{D}\left( \frac{2+x}{2^{2}} \right) + \tilde{D}\left( \frac{1+x}{2^{2}} \right) + \tilde{D}\left( \frac{3+x}{2^{2}} \right)$$
$$2^{n} \tilde{D}(x) = \sum_{k = 0}^{n-1} \tilde{D}\left( \frac{x+k}{2^{n}} \right)$$
