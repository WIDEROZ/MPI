...
#### b.
$$g(x)-\frac{1}{x} = \sum_{n= 1}^{+ \infty}\left( \frac{1}{x+n}+\frac{1}{x-n} \right) = \sum_{n = 1}^{+ \infty} $$
$$\left|\left| \frac{1}{x+n}+\frac{1}{x-n} \right|\right| _{\infty, \mathbb{R} \setminus \mathbb{Z}} = \sup_{x \in \mathbb{R} \setminus \mathbb{Z}} \left| \frac{1}{x+n}+\frac{1}{x-n}\right| $$
$$ = \sup_{x \in [0, n[}\left| 2\frac{x}{x^{2}-n^{2}}\right| = 2n$$
