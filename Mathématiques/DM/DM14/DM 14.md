...
On a alors : 
$$\forall N \in \mathbb{N}^{*}, \int _{2}^{N} \frac{1}{x+t} - \frac{1}{t-x}\, dt = \ln\left( \left| \frac{x+N}{N-x}\right| \right)  + \ln\left( \left| \frac{2-x}{x+2}\right| \right)$$
...
Ainsi, 
$$\ln\left( \left| \frac{1-x}{x+1}\right| \right) \leq \sum_{k = 1}^{+ \infty} \left( \frac{1}{1+k} + \frac{1}{x-k} \right) \leq \ln\left( \left| \frac{x}{x+1}\right| \right)$$
Ainsi, 
$$\ln\left( \left| \frac{1-x}{x+1}\right| \right) \underset{x \to 0}{\longrightarrow} 0 \text{ et } \ln\left( \left| \frac{x}{x+1}\right| \right) \underset{x \to 0}{\longrightarrow} 0$$
