...
$$\mathrm{cotan}\left( \frac{x}{2} \right) = \frac{\cos\left( \frac{x}{2} \right)}{\sin\left( \frac{x}{2} \right)} = i\frac{e^{ i \frac{x}{2} }+e^{ -i \frac{x}{2} }}{e^{ i \frac{x}{2} }-e^{ -i \frac{x}{2} }} = i \frac{e^{ ix }+ 1}{e^{ ix }-1}$$
$$= i \frac{e^{ ix }+1}{e^{ ix }-1} + \frac{2i}{e^{ ix }-1}= i \frac{(e^{ ix }+1)(e^{ -ix }-1)}{(e^{ ix }-1)(e^{ -ix }-1)} +\frac{2i}{e^{ ix }-1}$$
$$= i \frac{1-e^{ ix }+e^{ -ix }-1}{1 - e^{ ix } - e^{ -ix }+1} + \frac{2i}{e^{ ix }-1}= -i \frac{e^{ -ix }- e^{ ix }}{2+e^{ ix }-e^{ -ix }}$$
