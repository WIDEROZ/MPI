...
$$\int_{1}^{+ \infty} h_{x}(t) dt \leq \sum_{k = 1}^{+ \infty} \left( \frac{1}{x+k} + \frac{1}{x-k} \right) \leq \int_{0}^{+ \infty}  h_{x}(t)  dt $$
On a alors : 
$$\int _{1}^{N} \frac{1}{x+t} - \frac{1}{t-x}\, dt = \ln\left( \frac{x+N}{N-x} \right)  + \ln\left( \frac{x-1}{x+1} \right)$$
$$= \ln\left( \frac{\frac{x}{N}+1}{1-\frac{x}{N}} \right) + \ln\left( \frac{x-1}{x+1} \right) \underset{N \to +\infty}{\longrightarrow} \ln\left( \frac{x-1}{x+1} \right)$$
De même, 
$$\int_{0}^{+ \infty} h_{x}(t) \, dt = \ln\left( \frac{x+N}{N-x} \right)$$
