...
Alors, 
$$2\tilde{D}(\alpha)- \tilde{D}\left( \frac{\alpha}{2} \right) = \tilde{D}\left( \frac{1+\alpha}{2} \right)$$
or $2\tilde{D}(\alpha) - \tilde{D}\left( \frac{\alpha}{2} \right)=\tilde{D}(\alpha)$
Alors, 

$$\sum_{k = 1}^{n+1}\tilde{D}\left( \frac{\alpha + k}{2^{n}} \right) = (2^{n}-1)\tilde{D}\left( \frac{\alpha}{2^{n}} \right)$$
