...
Alors, 
Pour $x \in ]0, 1[$, 
$$\frac{\left\lfloor 2^{n}x \right\rfloor + \alpha}{2^{n}}\leq x + \frac{\alpha}{2^{n}} < 1+ \frac{1}{2^{n}} < $$

$$\forall x \in ]0, 1[, \tilde{D}(\alpha) = \tilde{D}(\alpha + \left\lfloor 2^{n}x \right\rfloor ) = \tilde{D}\left( \frac{\alpha + \left\lfloor 2^{n}x \right\rfloor }{2^{n}} \right) \underset{n \to +\infty}{\longrightarrow}  \tilde{D}\left( x \right)$$
