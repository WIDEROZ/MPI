...
elle est aussi dérivable car : 
$$h'(0) = \lim_{ h \to 0 } \frac{h(h)-h(0)}{h} = \lim_{ h \to 0 } \frac{\frac{h}{e^{ h }-1} - 1}{h} = \lim_{ h \to 0 } \frac{\frac{h}{h+\frac{h^{2}}{2}+o(h^{2})}-1}{h} = \lim_{ h \to 0 } \frac{1}{h+\frac{h^{2}}{2}+o(h^{2})} -\frac{1}{h}$$
