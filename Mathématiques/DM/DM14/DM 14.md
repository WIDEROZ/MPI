...
$$\frac{2}{x}\int_{1}^{+ \infty} \frac{dt}{1-\left( \frac{t}{x} \right)^{2}}  \leq \sum_{k = 1}^{+ \infty} \left( \frac{1}{x+k} + \frac{1}{x-k} \right) \leq \frac{2}{x}\int_{0}^{+ \infty} \frac{dt}{1-\left( \frac{t}{x} \right)^{2}}  $$
$$\int _{1}^{+ \infty} \frac{1}{x+t} \, dt = \ln\left( \frac{x^{2}-N^{2}}{x^{2}-1} \right)$$
