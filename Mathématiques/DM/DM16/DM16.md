...
$$\frac{1}{I_{N}} \int_{-\pi}^{\pi} \left| t\right|D_{N}^{4}(t) \, dt \leq 2\pi^{4}\left( N+\frac{1}{2} \right)^{2} \frac{\int_{0}^{+ \infty}\frac{\sin ^{4}(t)}{t^{3}} \, dt }{CN^{3} } \leq \frac{2\pi^{4}}{C} \left( \frac{1}{N} + \frac{1}{2N^{2}} + \frac{1}{4N^{3}} \right) $$
