...
\end{cases}$$
$$\frac{\partial f}{\partial b} = \frac{\frac{1}{a-\cos(t)}(a-\cos(t))}{b-\cos(t)} = \frac{1}{b-\cos(t)} \leq \frac{1}{1-\cos(t)} \leq \frac{1}{(1-\cos(t))^{3/2}}$$

$$2^{3/2} = 2\sqrt{2} \text{ et } 4^{3/2} = \sqrt{64}$$
