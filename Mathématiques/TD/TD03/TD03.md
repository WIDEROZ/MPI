...
Soit $n \in \mathbb{N}$, 
Soit $y \in I_{k_{0}}$, il existe $x_{k_{0}}, x_{k_{0}+1} \in E$ tels que :
$$f^{k_{0}}(x_{k_{0}}) = f^{k_{0}+1}(x_{k_{0}+1}) = y$$
alors, 
$$f^{k_{0}+1}(x_{k_{0}}) = f^{k_{0}+2}(x_{k_{0}+1}) = f(y) \in I_{k_{0}+1} \cap I_{k_{0}+2}$$
