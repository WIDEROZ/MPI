...
$$P_{n}\left( \frac{1}{x} \right)f^{}(x) = \left( \frac{1}{x^{2}}P_{n}\left( \frac{1}{x} \right)-P_{n+1}\left( \frac{1}{x} \right) \right) f(x)$$
Alors, 
$$P_{n+1}\left( \frac{1}{x} \right)f(x) = P_{n}\left( \frac{1}{x} \right) \left( \frac{1}{x^{2}}-1 \right)f(x) $$
Donc, par réccurence très rapide
$$f^{(n+1)}(x) = P'_{n}\left( \frac{1}{x} \right)f^{(n)}(x) +\frac{1}{x^{2}}P_{n}\left( \frac{1}{x} \right)f^{(n)}(x)$$
