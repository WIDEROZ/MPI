...
## c.
$$\forall n \in \mathbb{N}, \left| \int_{0}^{1}(n+1)e^{ -x }x^{n} \, dx \right| \leq \int _{0}^{1}\left| x^{n}(n+1)\right| \, dx \leq n+1 \leq$$
car $\forall n \in \mathbb{N}, \sup_{x \in [0, 1]} x^{n}(n+1) = n+1$
Alors, 
$$\forall n \in \mathbb{N}, n+1 \leq (n+1)f(n)\leq n+1$$