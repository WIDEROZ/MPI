...
en $0$ : 
$$-\sin\left( \frac{1}{x^{2}} \right)\left( \frac{1}{\sqrt{x}} \right) + o\left( \frac{1}{x} \right)=-\frac{\sqrt{x}}{\ln(1+x)} \leq \frac{\sqrt{x}\sin\left( \frac{1}{x^{2}} \right)}{\ln(1+x)} \leq \frac{\sqrt{x}}{\ln(1+x)} = \frac{1}{\sqrt{x}} + o\left( \frac{1}{x} \right)$$
$$\frac{\sqrt{x}\sin\left( \frac{1}{x^{2}} \right)}{\ln(1+x)} = \sin\left( \frac{1}{x^{2}} \right)\left( \frac{1}{\sqrt{x} + o(\sqrt{x})}\right)$$
$$ \sin\left( \frac{1}{x^{2}} \right)\left( \frac{1}{\sqrt{x} + o(\sqrt{x})}\right) \geq - \left( \frac{1}{\sqrt{x} + o(\sqrt{x})}\right) \sim -\frac{1}{\sqrt{x}}$$
	
## i.
$$\sqrt{t+\cos(t)} - \sqrt{t} = \sqrt{t}\left( \sqrt{1+\frac{\cos(t)}{t}} - 1 \right) $$
