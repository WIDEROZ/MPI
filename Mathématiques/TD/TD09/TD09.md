...
en $0$ : 
$$-\frac{1}{\sqrt{x}} + o\left( \frac{1}{x} \right)=-\frac{\sqrt{x}}{\ln(1+x)} \leq \frac{\sqrt{x}\sin\left( \frac{1}{x^{2}} \right)}{\ln(1+x)} \leq \frac{\sqrt{x}}{\ln(1+x)} = \frac{1}{\sqrt{x}} + o\left( \frac{1}{x} \right)$$
L'intégrale diverge car $1=1$
$$\left| \frac{\sqrt{x}\sin\left( \frac{1}{x^{2}} \right)}{\ln(1+x)}\right|\leq \frac{1}{\sqrt{x}} + o\left( \frac{1}{x} \right)$$
