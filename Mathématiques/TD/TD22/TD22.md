...
#### c.
##### i.
$$\left|\left| X \right|\right| ^{2} = \left< X, X \right> = $$
$$U^{\top}(A+A^{\top})U = U^{\top}A U + U^{\top} A^{\top} U $$
$$U^{\top} U' + U^{\top}A^{\top}U = U^{\top} U' + (U')^{\top}U $$
$$A = \frac{A^{\top}+A}{2} + \frac{A-A^{\top}}{2}$$
$$\left|\left| X \right|\right| ^{2} = \left|\left| e^{ tA }U \right|\right| ^{2} $$
