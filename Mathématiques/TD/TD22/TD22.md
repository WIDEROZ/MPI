...
$$\forall n \in\mathbb{N}^{*} \text{pair}, (k+1)^{2}a_{k+1} + a_{k-1} =0 \Rightarrow a_{k+1} = -\frac{1}{(k+1)^{2}}a_{k-1}$$
$$a_{n+1} = \frac{1}{(n+1)^{2}(n-1)^{2}}a_{n-3} = \frac{(-1)^{\left\lfloor n/2+1 \right\rfloor }}{(n+1)^{2}(n-1)^{2}\dots 2^{2}}a_{0}$$
$$a_{n+1} = \frac{(-1)^{\left\lfloor n/2+1 \right\rfloor }}{\prod_{k = -1}^{\left\lfloor n/2 +1\right\rfloor }((2k+1)-n)^{2}}$$
