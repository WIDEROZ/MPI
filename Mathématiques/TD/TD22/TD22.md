...
$$= -\frac{\arctan(x)}{x+1} -\frac{1}{4}(3\ln(1+x) - 2 \arctan(x) )$$
Alors, 
$$C(x) = \frac{1}{4}(3\ln(1+x) - 2\arctan (x))-\frac{\arctan(x)}{x+1} + K$$

Ainsi, Pour tout $x \in E$, 
$$y(x) = \left(\frac{1}{4}(3\ln(1+x) - 2\arctan (x))-\frac{\arctan(x)}{x+1}+K\right)\left( 1+\frac{1}{x} \right)$$
Pour $x = 0$ : 
$$(\mathcal{E}) : y(0) = 0$$
Pour $x = -1$ : 
$$(\mathcal{E}) : y(-1) = -\arctan(1) = -\frac{\pi}{4}$$
